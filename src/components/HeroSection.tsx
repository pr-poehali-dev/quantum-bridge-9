...
export function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-12 pb-8 text-center">
      ...
      <p className="mb-8 max-w-xl text-gray-400">ESP, KillAura, Fly, AutoClicker и десятки других модулей — всё в одном клиенте с обходом всех популярных античитов.</p>
